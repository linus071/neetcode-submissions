...
class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        #    -> EXAMPLE: If t = "AAB", we need 2 unique chars ('A' and 'B').
        #       If our window has "A" and "B", have = 1 (because 'B' is satisfied, but 'A' still needs 1 more).
        #       Once our window gets another "A" (total 2), then have = 2.
